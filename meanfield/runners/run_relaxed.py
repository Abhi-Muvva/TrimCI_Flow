"""
Meanfield SCF — relaxed convergence criteria. CURRENT WORKING BASELINE.

Convergence thresholds are set to the stochastic noise floor of the TrimCI
solver at N=5 gamma averaging:
    energy    : 5e-2 Ha  (stochastic CI shot noise floor)
    gamma     : 1e-2     (max|Δγ|, practical noise floor at N=5)

This run converges in ~43 iterations with Anderson active 37/43 steps.

Output: TrimCI_Flow/Outputs/meanfield_active/outs_relaxed_n5/
"""
...
OUTDIR  = ROOT / "TrimCI_Flow" / "Outputs" / "meanfield_active" / "outs_relaxed_n5"
