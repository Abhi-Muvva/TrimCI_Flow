"""Experiment 1: Ref-det init + electron-number renorm, damping=0.1, default trimci config."""
import json
import os
...
OUT_DIR = "outs_phaseB_refinit_damp01"
...
# Metadata JSON
meta = {
    "run_type": "Phase_B_refinit_damp01",
...
# Iteration history -- replace inf with null in JSON for delta_E / delta_rdm on iter 0
hist_out = []
...
print(f"\nExperiment 1 complete. converged={result.converged}, iters={result.iterations}")
